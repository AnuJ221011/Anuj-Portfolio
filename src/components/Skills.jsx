...
const skills = [
  ...
  { name: "Java", img: goIcon, category: "Languages", level: 75, color: "from-cyan-400 to-blue-500" },
...
const Skills = () => {
  ...
  return (
    <section className="relative p-5 mx-20 mb-10 font-['Poppins'] max-sm:p-2 max-sm:mx-5 min-h-screen" id="skills">
      {/* Background Elements */}
